...
<div>
    <div id="testdiv">
        <div class="flex-container" style=" padding: 20px 0px; line-height:3px;">
            ...
            <div style="width:70%;text-align:center; float: left; margin-left: 150px; margin-top: -70px;">  <h1 style="font-size:30px;"> M/S Rabah International </h1> <p style="font-size:14px;"> (Govt. Approved Recruiting Agent ,RL No-1291) </p> </div>
        ...
        <div class="flex-container padding">
            <div class="flex-item-2">1. Name of the emplyer <br/> &nbsp;&nbsp;&nbsp;&nbsp;in saudi arabia  </div>
        ...
        <div class="flex-container padding">
            <div class="flex-item-2">3. full name of the emplyee  </div>
