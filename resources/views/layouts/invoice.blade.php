...
<head>
    ...
    <!-- uikit -->
    <link rel="stylesheet" href="{{ url('admin/bower_components/uikit/css/uikit.almost-flat.min.css') }}" media="all">

    <!-- flag icons -->
    <link rel="stylesheet" href="{{ url('admin/assets/icons/flags/flags.min.css') }}" media="all">
