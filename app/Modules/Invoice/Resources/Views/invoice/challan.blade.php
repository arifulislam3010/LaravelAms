                        ...
                        <div class="md-card-content invoice_content print_bg" style="">
                            ...
                            <div class="uk-grid" data-uk-grid-margin>
                                ...
                                <div class="uk-width-5-5">
                                    <div class="uk-grid">
                                        <h2 style="text-align: center; width: 90%;" class="">CHALLAN</h2>
                                ...
                                <div class="uk-width-small-1-2 uk-row-first">
                                    <div class="uk-margin-bottom">
                                        ...
                                        <address>
                                            ...
                                            <p>Billing Address-{{ $invoice->customer->billing_street }},{{ $invoice->customer->billing_city }},{{ $invoice->customer->billing_state }},{{ $invoice->customer->billing_zip_code }},{{ $invoice->customer->billing_country }}</p>
                                            <p>Shipping address-{{ $invoice->customer->shipping_street }},{{ $invoice->customer->shipping_city }},{{ $invoice->customer->shipping_state }},{{ $invoice->customer->shipping_zip_code }},{{ $invoice->customer->shipping_country }}</p>
                                        </address>
                                    </div>
                                </div>
                            ...
                            <div class="uk-grid uk-margin-large-bottom" style="font-size: 12px;">
                                <div class="uk-width-1-1">
                                    <table class="uk-table" style="font-size: 12px;" report_table >
                                        <thead>
