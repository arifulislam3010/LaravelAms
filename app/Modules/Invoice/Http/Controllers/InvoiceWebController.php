...
class InvoiceWebController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('invoice::invoice.create', compact('customers','invoice_number', 'agents'));
    }
    ...
    public function saveUpdate(Request $request,$id){
       ...
       // dd($data);
        ...
        if ($status1==false){
           ...
           $status1= $this->insertAgainJournalEntries($invoice, $id, $agent_commission_amount);
    ...
    public function saveUpdate2($id){
        ...
        if ($status1==false)
        {
            $status1= $this->insertAgainJournalEntries($invoice,'0');
    ...
    public function insertAgainJournalEntries($data,$agent_commission_amount)
    {
       try{
           $user_id = Auth::user()->id;
           $i = 0;
           $discount = InvoiceEntry::where('invoice_id',$data->id)->select(DB::raw('sum(rate-amount) as discount'))->first();
    ...
    public function addStock($id){
        ...
        return redirect()->back()->with('msg','stock added succesfully');
