                    ...
                    <div class="md-card">
                        ...
                        <div class="user_content">
                                    ...
                                    @foreach($medical as $value)
                                        <tr>
                                           ...
                                           <td class="uk-text-center">
                                                ...
                                                <a onclick="deleterow(this); return false" href="{!! route('medicalslip_delete',$value->id) !!}" class=""><i class="md-icon material-icons">&#xE872;</i></a>
                                            </td>
                                        </tr>
                            ...
                            <div class="md-fab-wrapper branch-create">
                                <a id="add_branch_button" href="{!! route('medicalslip_create') !!}" class="md-fab md-fab-accent branch-create">
