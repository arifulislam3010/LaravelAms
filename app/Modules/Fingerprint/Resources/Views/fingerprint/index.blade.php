                    ...
                    <div class="md-card">
                        <div class="user_heading">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b"><span class="uk-text-truncate">Finger Print List</span></h2>
                            </div>
                        </div>
                        ...
                        <div class="user_content">
                                    ...
                                    @foreach($finger as $value)
                                            <tr>
                                                ...
                                                <td class="uk-text-center">
                                                    ...
                                                    <input type="hidden" class="fingerprint_id" value="{{ $value->id }}">
                                                </td>
                                            </tr>
                            ...
                            <div class="md-fab-wrapper branch-create">
                                <a id="add_branch_button" href="{!! route('fingerprint_create') !!}" class="md-fab md-fab-accent branch-create">
