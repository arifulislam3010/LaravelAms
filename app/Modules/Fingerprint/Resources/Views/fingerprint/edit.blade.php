...
@section('title', 'Finger Print Edit')
...
@section('content')
    <div class="uk-grid" ng-controller="InvoiceController">
        <div class="uk-width-large-10-10">
            ...
            @endif
            {!! Form::open(['url' => route('fingerprint_update',$finger->id), 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'my_profile', 'files' => 'true', 'enctype' => "multipart/form-data", 'novalidate']) !!}
                            ...
                            <div class="uk-margin-top">
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="invoice_date" value="{!! $finger->assignedDate !!}" name="assignedDate" data-uk-datepicker="{format:'YYYY-MM-DD'}">
                                        @if($errors->has('date'))
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        <label for="invoice_date">Select date</label>
                                        <input class="md-input" type="text" id="invoice_date" value="{!! $finger->receivingDate !!}" name="receivingDate" data-uk-datepicker="{format:'YYYY-MM-DD'}">
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <textarea type="text" name="comment" class="md-input" cols="4" rows="4">{!! $finger->comment !!}</textarea>
                                        @if($errors->has('name'))
                                ...
                                <div class="uk-grid uk-grid-small">
                                    ...
                                    <div class="uk-width-large-2-3">
                                        <span class="uk-text-large uk-text-middle">{!! isset($finger->createdBy['name']) ? $finger->createdBy['name']:''  !!}</span>
                                    </div>
                                </div>
                                <div class="uk-grid uk-grid-small">
                                    <div class="uk-width-large-1-3">
                                    ...
                                    <div class="uk-width-large-2-3">
                                        <span class="uk-text-large uk-text-middle">{!! isset($finger->updatedBy['name']) ? $finger->updatedBy['name']:''  !!}</span>
                                    </div>
                                </div>
                                ...
                                <div class="uk-grid uk-grid-small">
                                    ...
                                    <div class="uk-width-large-2-3">
                                        <span class="uk-text-large uk-text-middle">{!! isset($finger->created_at) ? $finger->created_at:''  !!}</span>
                                    </div>
                                </div>
                                <div class="uk-grid uk-grid-small">
                                    <div class="uk-width-large-1-3">
                                    ...
                                    <div class="uk-width-large-2-3">
                                        <span class="uk-text-large uk-text-middle">{!! isset($finger->updated_at) ? $finger->updated_at:''  !!}</span>
                                    </div>
                                </div>
