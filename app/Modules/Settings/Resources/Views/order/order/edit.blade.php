                                ...
                                <div class="uk-margin-top">
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-1-5 uk-vertical-align">
                                            <label class="uk-vertical-align-middle" for="contact_id">Contact Name</label>
                                        </div>
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <select data-md-selectize data-md-selectize-bottom data-uk-tooltip="{pos:'top'}" title="Select Customer" id="contact_id" name="contact_id">
                                                ...
                                                @foreach($contact as $value)
                                                    ...
                                                    @else
                                                        <option value=" {{ $value->id }} " {{ $order->contact_id? "selected":"" }}> {{ $value->display_name }} </option>
                                                        @endif
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-1-5 uk-vertical-align">
                                            <label class="uk-vertical-align-middle" for="contact_id">Customer Category Name</label>
                                        </div>
                                        <div class="uk-width-medium-2-5">
                                            <label for="contact_id">Customer Category name</label>
                                            <select data-md-selectize data-md-selectize-bottom data-uk-tooltip="{pos:'top'}" title="Select Customer Category" id="vendor_id" name="vendor_id" required>
                                                ...
                                                @foreach($test as $value)
                                                    @if($value->contact_category_id==$order->vendor_id)
                                                    <option value=" {{ $value->contact_category_id }}" selected > {{ $value->display_name }} </option>
                                                    @else
                                                        <option value=" {{ $value->contact_category_id }}"> {{ $value->display_name }} </option>
                                                        @endif
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            <label for="recordLocator">Ticket Number</label>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="departureTime" data-uk-datepicker="{format:'YYYY-MM-DD'}" name="departureTime" value="{{ $order->departureTime  }} " />
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="time" id="returnflightdepartureTime"   name="returnflightdepartureTime" value="{{ $order->returnflightdepartureTime  }} " />
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        <div class="uk-width-medium-1-5 uk-vertical-align">
                                            <label class="uk-vertical-align-middle" for="returnflightarrivalDate">Issu Date</label>
                                        </div>
                                        <div class="uk-width-medium-2-5">
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        <div class="uk-width-medium-1-5 uk-vertical-align">
                                            <label class="uk-vertical-align-middle" for="documentNumber">Transaction Amount</label>
                                        </div>
                                        <div class="uk-width-medium-2-5">

                                            <label for="documentNumber">Transaction Amount</label>
                                            <input class="md-input" type="number" id="adultPassenger"   name="transactionAmount" value="{!! $order->transactionAmount !!}" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="number" id="adultPassenger"   name="taxOnCommission" value="{!! $order->taxOnCommission !!}" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="md-card">
                                        <div class="md-card-content">
                                            <h3 class="heading_a">Select Ticket Tax</h3>
                                            <div class="uk-grid" data-uk-grid-margin>
                                                <div class="uk-width-large-1-2">

                                                    <select id="selec_adv_1" name="ticket_tax_id[]" multiple>
                                                        @foreach($ticket_tax as $value)
                                                        @foreach($order_pax as $item)
                                                            @if($value->id==$item->ticket_tax_id)
                                                                <option value="{!! $value->id !!}" selected>{!! $value->title !!}</option>
                                                            @endif
                                                        @endforeach
                                                        @endforeach
