...
@section('title', 'Confirmed Ticket Order')
                    ...
                    <div class="md-card">
                        <div class="user_heading">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b"><span class="uk-text-truncate">Confirmed Ticket Order List</span></h2>
                                    ...
                                    @foreach($order as $value)
                                        <tr>
                                            ...
                                            <td class="uk-text-center">
                                                ...
                                                <a href="{!! route('ticket_Order_sendMail',$value->id) !!}"><i class="material-icons">&#xE0BE;</i></a>
...
@section('scripts')
    <script>
        $('.delete_btn').click(function () {
            var id = $(this).next('.confirmed_id').val();
            swal({
                title: 'Are you sure?',
