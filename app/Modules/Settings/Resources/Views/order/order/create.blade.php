                                ...
                                <div class="uk-margin-top">
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="departureTime" data-uk-datepicker="{format:'YYYY-MM-DD'}"  name="departureTime" value="{{ old('departureTime')}} " />
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="time" id="returnflightdepartureTime"   name="returnflightdepartureTime" value="{{ old('returnflightdepartureTime')}} " />
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="number" id="adultPassenger" value="{!! isset($commition->commissionRate)?$commition->commissionRate:'' !!}" name="commissionRate"/>
                                        </div>
                                    </div>
                                    <div class="uk-grid" data-uk-grid-margin>
                                        <div class="uk-width-medium-1-5 uk-vertical-align">
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="number" id="adultPassenger" value="{!! isset($commition->commissionTax)? $commition->commissionTax:'' !!}" name="taxOnCommission"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="md-card">
                                        <div class="md-card-content">
                                            <h3 class="heading_a">Select Ticket Tax <span style="color: red">*</span></h3>
                                            <div class="uk-grid">
                                    ...
                                    <div class="uk-grid uk-ma" data-uk-grid-margin>
                                        <div class="uk-width-1-1 uk-float-left">
                                            <input type="submit" class="md-btn md-btn-primary" value="Save & Confirm" name="confirm" />
