...
@section('content')
    <div class="uk-grid" ng-controller="InvoiceController">
        <div class="uk-width-large-10-10">
            ...
            @endif
            {!! Form::open(['url' => route('ticket_document_update',$ticket->id), 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'my_profile', 'files' => 'true', 'enctype' => "multipart/form-data", 'novalidate']) !!}
                            ...
                            <div class="uk-margin-top">
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        <select data-md-selectize data-md-selectize-bottom data-uk-tooltip="{pos:'top'}" title="Select Order id" id="order_id" name="order_id">
                                            <option value="">Select Order ID</option>
                                            @foreach($order as $value)
                                                @if($value->id==$ticket->order_id)
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" value="{!! $ticket->title !!}" id="name" name="title">
                                        @if($errors->has('title'))
                                            <br/>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <textarea type="text" name="note" id="note" class="md-input" cols="4" rows="4">{!! $ticket->note !!}</textarea>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        <input class="md-input" type="file" value="{!! $ticket->file_url !!}" id="file" name="file_url">
                                ...
                                <div class="uk-grid uk-grid-small">
                                    ...
                                    <div class="uk-width-large-2-3">
                                        <span class="uk-text-large uk-text-middle">{!! isset($ticket->createdBy['name']) ? $ticket->createdBy['name']:''  !!}</span>
                                    </div>
                                </div>
                                <div class="uk-grid uk-grid-small">
                                    <div class="uk-width-large-1-3">
                                    ...
                                    <div class="uk-width-large-2-3">
                                        <span class="uk-text-large uk-text-middle">{!! isset($ticket->updatedBy['name']) ? $ticket->updatedBy['name']:''  !!}</span>
                                    </div>
                                </div>
                                ...
                                <div class="uk-grid uk-grid-small">
                                    ...
                                    <div class="uk-width-large-2-3">
                                        <span class="uk-text-large uk-text-middle">{!! isset($ticket->created_at) ? $ticket->created_at:''  !!}</span>
                                    </div>
                                </div>
                                <div class="uk-grid uk-grid-small">
                                    <div class="uk-width-large-1-3">
