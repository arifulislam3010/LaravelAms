                ...
                <div class="uk-grid" data-uk-grid-margin="">
                    <div class="uk-width-large-1-4 uk-width-medium-1-1">
                        <div class="uk-input-group">
                            ...
                            <input class="md-input" name="from_date" value="{!! $t !!}" data-uk-datepicker="{format:'YYYY-MM-DD'}" type="text">
                        </div>
                    ...
                    <div class="uk-width-large-1-4 uk-width-medium-1-1">
                        <div class="uk-input-group">
                            ...
                            <input class="md-input" name="to_date" data-uk-datepicker="{format:'YYYY-MM-DD'}" type="text">
                        </div>
