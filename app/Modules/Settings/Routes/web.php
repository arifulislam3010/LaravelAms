...
Route::group(['prefix' => 'ticket/settings/commissions'],  function () {

    Route::get('/edit/{id}', 'ticket\ticketcommission\PostController@edit')->name('ticket_commission_edit')->middleware('auth');
    Route::post('/update/{id}', 'ticket\ticketcommission\PostController@update')->name('ticket_commission_update')->middleware('auth');
...
Route::group(['prefix' => 'ticket/order'], function () {
    ...
    Route::get('/pending', 'Order\order\PostController@pending')->name('ticket_Order_pending')->middleware('auth');
    Route::get('/confirmed', 'Order\order\PostController@confirmed')->name('ticket_Order_confirmed')->middleware('auth');
    Route::get('/create', 'Order\order\PostController@create')->name('ticket_Order_create')->middleware('auth');
    Route::post('/store', 'Order\order\PostController@store')->name('ticket_Order_store')->middleware('auth');
    Route::get('/edit/{id}', 'Order\order\PostController@edit')->name('ticket_Order_edit')->middleware('auth');
    Route::post('/update/{id}', 'Order\order\PostController@update')->name('ticket_Order_update')->middleware('auth');
    Route::get('/pdf/{id}', 'Order\order\PostController@orderPdf')->name('ticket_Order_pdf')->middleware('auth');
    Route::get('/destory/{id}/{bill}/{invoice}', 'Order\order\PostController@destroy')->name('ticket_Order_destroy')->middleware('auth');
    Route::get('/pendingupdate/{id}', 'Order\order\PostController@pendinUpdate')->name('ticket_Order_pendingUpdate')->middleware('auth');

    //send mail to order

    Route::get('/mail/{id}', 'Order\order\PostController@orderMail')->name('ticket_Order_sendMail')->middleware('auth');
    Route::post('/mail/store/{id}', 'Order\order\PostController@orderMailStore')->name('ticket_Order_sendMailStore')->middleware('auth');
    Route::get('/sendmail/show/', 'Order\order\PostController@SendMailShow')->name('another_mail_send_show')->middleware('auth');
    Route::post('/sendmail/show/', 'Order\order\PostController@SendMailShowbyfilter')->name('another_mail_send_show_filter')->middleware('auth');
    Route::get('/sendmail/show/{id}', 'Order\order\PostController@SendMailShowPerID')->name('send_mail_show_per_id')->middleware('auth');

    //Ticket bill route

    Route::get('/bill/show/{id}/{order}', 'Order\order\TicketBillInvoiceController@billShow')->name('ticket_Order_bill_show')->middleware('auth');
    Route::get('/bill/show/{order}', 'Order\order\TicketBillInvoiceController@billCreate')->name('order_ticket_bill_create')->middleware('auth');
    Route::post('/bill/store', 'Order\order\TicketBillInvoiceController@billStore')->name('ticket_bill_store')->middleware('auth');

    //ticket invoice route

    Route::get('/invoice/show/{id}/{order}', 'Order\order\TicketBillInvoiceController@invoiceShow')->name('ticket_Order_invoice_show')->middleware('auth');
    Route::get('/invoice/show/{order}', 'Order\order\TicketBillInvoiceController@invoiceCreate')->name('order_ticket_invoice_create')->middleware('auth');
    Route::post('/invoice/store', 'Order\order\TicketBillInvoiceController@invoiceStore')->name('ticket_invoice_store')->middleware('auth');
...
Route::group(['prefix' => 'ticket/document','middleware' => 'auth'], function () {
    ...
    Route::get('/', 'ticket\ticket_document\TicketDocumentController@index')->name('ticket_document_index');
    Route::get('/create', 'ticket\ticket_document\TicketDocumentController@create')->name('ticket_document_create');
    Route::post('/store', 'ticket\ticket_document\TicketDocumentController@store')->name('ticket_document_store');
    Route::get('/edit/{id}', 'ticket\ticket_document\TicketDocumentController@edit')->name('ticket_document_edit');
    Route::post('/update/{id}', 'ticket\ticket_document\TicketDocumentController@update')->name('ticket_document_update');
    Route::get('/delete/{id?}', 'ticket\ticket_document\TicketDocumentController@delete')->name('ticket_document_delete');

    //shanto

    Route::get('/download/{id}', 'ticket\ticket_document\TicketDocumentController@download')->name('ticket_document_download');
    Route::get('/send/mail/{id}', 'ticket\ticket_document\TicketDocumentController@sendMail')->name('ticket_document_sendMail');
    Route::post('/send/mail/store/{id}', 'ticket\ticket_document\TicketDocumentController@sendMailStore')->name('ticket_document_sendMail_store');
...
Route::group(['prefix' => 'ticket/hotel','middleware' => 'auth'], function () {
    ...
    Route::get('/', 'ticket\ticket_hotel\TicketHotelController@index')->name('ticket_hotel_index');
    Route::get('/create', 'ticket\ticket_hotel\TicketHotelController@create')->name('ticket_hotel_create');
    Route::post('/store', 'ticket\ticket_hotel\TicketHotelController@store')->name('ticket_hotel_store');
    Route::get('/edit/{id}', 'ticket\ticket_hotel\TicketHotelController@edit')->name('ticket_hotel_edit');
    Route::post('/update/{id}', 'ticket\ticket_hotel\TicketHotelController@update')->name('ticket_hotel_update');
    Route::get('/delete/{id?}', 'ticket\ticket_hotel\TicketHotelController@delete')->name('ticket_hotel_delete');
...
Route::group(['prefix' => 'ticket/IATA/bill','middleware' => 'auth'], function () {
    ...
    Route::get('/', 'IataBillController@bill')->name('ticket_bill_index');
    Route::post('/find_bill', 'IataBillController@find_bill')->name('find_bill');
...
Route::group(['prefix' => 'ticket/dashboard','middleware' => 'auth'], function () {
    ...
    Route::get('/', 'TicketDashboardController@dashboard')->name('ticket_dashboard_index');
    Route::post('/filter', 'TicketDashboardController@filter')->name('ticket_dashboard_filter');
