                    ...
                    <div class="md-card">
                        <div class="user_heading" data-uk-sticky="{ top: 48, media: 960 }">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b"><span class="uk-text-truncate">Update Sector</span></h2>
                            </div>
                        </div>
                        <div class="user_content">
                            <div class="uk-margin-top">
                                {!! Form::open(['url' => route('order_expense_sector_update', ['id' => $category->id]), 'method' => 'POST']) !!}
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="contact_category_name" name="contact_category_name" value="{{ old('contact_category_name') ? old('contact_category_name') : $category->title }}" required/>
                                        @if($errors->first('contact_category_name'))
                                            <div class="uk-text-danger">Sector name is required.</div>
                                        @endif
                                    </div>
                                </div>
                                <div class="uk-grid">
                                    ...
                                    <div class="uk-width-medium-4-5">
                                        ...
                                        <textarea class="md-input" name="contact_category_description" id="contact_category_description" cols="30" rows="4" >{{ old('contact_category_description') ? old('contact_category_description') : $category->summary }}</textarea>
                                        @if($errors->first('contact_category_description'))
                                            <div class="uk-text-danger">Sector description is required.</div>
                                        @endif
                                    </div>
                                </div>
                                <div class="uk-grid">
