                            ...
                            <div class="user_content">
                                <div class="uk-margin-top">
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            <select data-md-selectize data-md-selectize-bottom data-uk-tooltip="{pos:'top'}" title="Select Any" id="paid_through_id" name="paid_through_id">
                                                @foreach($paid_throughs as $paid_through)
                                                    @if($paid_through->id == old('payment_mode_id' ))
                                                        <option value="{{$paid_through->id}}" selected>{{$paid_through->account_name}}</option>
                                                    @else
                                                        <option value="{{$paid_through->id}}">{{$paid_through->account_name}}</option>
                                                    @endif
                                                @endforeach
                                            </select>
                                        </div>
