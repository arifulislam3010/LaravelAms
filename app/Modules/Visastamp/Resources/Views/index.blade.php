                    ...
                    <div class="md-card">
                        ...
                        <div class="user_content">
                          ...
                          {{--                      <a href="{!! route('visastamp_edit',$value->id) !!}" class="batch-edit"><i class="md-icon material-icons uk-margin-right">&#xE254;</i></a>--}}
                                                <a onclick="deleterow(this); return false" href="{{ route('visastamp_delete',$value->id) }}" data-uk-tooltip title="delete Item" class="batch-delete"><i class="md-icon material-icons">&#xE872;</i></a>
                                                {{--<a class="delete_btn"><i data-uk-tooltip="{pos:'top'}" title="Delete" class="md-icon material-icons">&#xE872;</i></a>
                                                <input type="hidden" class="visastamp_id" value="{{ $value->id }}">--}}
                                            </td>
                                        </tr>
...
@section('scripts')
    {{--<script>
        $('.delete_btn').click(function () {
            var id = $(this).next('.visastamp_id').val();
            swal({
                title: 'Are you sure?',
                ...
                window.location.href = "/visastamp/delete/"+id;
            })
        })
