                            ...
                            <div class="uk-width-1-1">
                                <table class="uk-table">
                                    ...
                                    <tr class="uk-text-upper">
                                        ...
                                        <th class="uk-text-center">Total Invoice</th>
                                        <th class="uk-text-center">Total Sales</th>
                                        <th class="uk-text-center">Total Payment Receives</th>
                                        <th class="uk-text-center">Total Receives</th>
                                    ...
                                    <tr class="uk-table-middle">
                                        ...
                                        <td class="uk-text-center">{{$customerReportData['invoices']}}</td>
                                        <td class="uk-text-center">{{$customerReportData['total_sales']}}</td>
                                        <td class="uk-text-center">{{$customerReportData['paymentreceives']}}</td>
