                                    ...
                                    <div class="uk-width-large-2-2 uk-width-2-2">
                                        ...
                                        <div class="uk-width-medium-2-2">
                                            <select id="report_account_id" name="report_account_id" data-md-selectize data-md-selectize-bottom data-uk-tooltip="{pos:'top'}">
                                                ...
                                                <option style="z-index: 10002" value="{{$itemData->id}}">{{$itemData->item_name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="uk-width-1-1">
                                <table class="uk-table">
                                    ...
                                    <tr class="uk-text-upper">
                                        ...
                                        <th class="uk-text-center">Purchases Quantity </th>
                                        <th class="uk-text-center">Sold Quantity </th>
                                        <th class="uk-text-center">Quantity Left</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    @foreach($item as $itemData)
                                    <tr class="uk-table-middle">
                                        <td class="uk-text-center"><a href="{{route('report_account_item_details',[$itemData->id])}}">{{$itemData->item_name}}</td>
                                        <td class="uk-text-center">{{$itemData->total_purchases}}</td>
                                        <td class="uk-text-center">{{$itemData->total_sales}}</td>
                                        <td class="uk-text-center">{{$itemData->total_purchases - $itemData->total_sales }}</td>
                                    </tr>
                                    @endforeach
                                    </tbody>
                                </table>
