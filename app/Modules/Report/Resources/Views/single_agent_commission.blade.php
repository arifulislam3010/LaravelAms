        ...
        window.onload = function () {
           var sum=0;
            ...
            for (var r = 0, n = table.rows.length; r < n; r++) {
                   ...
                   sum=sum+ parseFloat(table.rows[r].cells[3].innerText);
                   psum=psum+ parseFloat(table.rows[r].cells[4].innerText);
                   if(r==0){
                       balance = sum-psum;

                       table.rows[r].cells[5].innerText = balance
                   }else{
                       balance = balance + parseFloat(table.rows[r].cells[3].innerText)-parseFloat(table.rows[r].cells[4].innerText);
