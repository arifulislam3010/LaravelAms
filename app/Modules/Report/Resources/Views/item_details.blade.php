                                ...
                                <div class="uk-dropdown" aria-hidden="true">
                                 ...
                                 <li>
                                    ...
                                    @foreach($item as $itemData)
                                        <li>
                                            <a href="{{route('report_account_item_details',[$itemData->id])}}">{{$itemData->item_name}}</a>
                                        </li>
                                    @endforeach
                                    </ul>
                                </div>
                            ...
                            <div class="uk-width-1-1">
                                <table class="uk-table">
                                    ...
                                    <tr class="uk-table-middle">
                                        ...
                                        <td>{{$InvoiceEntryData->invoice->invoice_number}}</td>
                                        <td>{{$InvoiceEntryData->quantity}}</td>
                                        <td>{{$InvoiceEntryData->amount * $InvoiceEntryData->quantity }}</td>
                                        <?php $amount = $amount+($InvoiceEntryData->amount * $InvoiceEntryData->quantity); ?>
                                    </tr>
                                    @endforeach
                                     <tr class="uk-table-middle">
                                        <td></td>
