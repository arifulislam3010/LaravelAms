...
Route::group(['prefix' => 'report'], function () {
    ...
    Route::get('account/item/{id}', 'ReportWebController@itemDetails')->name('report_account_item_details')->middleware('read_access');
    ...
    Route::post('sales/agent', 'SalesCommissionReportController@filterbydate')->name('reportSalesdateby_agent')->middleware('auth');
    Route::get('sales/agent', 'SalesCommissionReportController@index')->name('report_Sales_by_agent')->middleware('auth');
    Route::get('sales/agent/details/{id}/{start}/{end}', 'SalesCommissionReportController@details')->name('report_Sales_by_agent_details')->middleware('auth');
    Route::post('sales/agent/details', 'SalesCommissionReportController@detailsbydate')->name('report_Sales_by_agent_detailsbydate')->middleware('auth');


    Route::get('stock', 'Stock\PostController@index')->name('report_stock_index_item')->middleware('auth');
    Route::post('stock', 'Stock\PostController@filter')->name('report_stock_index_item_filter')->middleware('auth');
    Route::get('stock/details/{id}/{start}/{end}', 'Stock\PostController@details')->name('report_stock_details_item')->middleware('auth');
