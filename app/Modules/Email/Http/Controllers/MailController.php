...
class MailController extends Controller
{
    ...
    public function mailSend(Request $request,$id){
        ...
        Mail::send('email::invoice.email',array('email'=>$email),function($messeg) use ($pdf){
    ...
    public function paymentMailSend(Request $request,$id)
    {
        ...
        Mail::send('email::paymentreceive.email', array('email' => $email), function ($messeg) use ($pdf) {

            $messeg->to(Input::get('email_address'))->subject('Welcome to Ontik Technology');

            $messeg->attachData($pdf->output(), "payment.pdf");
  ...
  public function creditMailSend(Request $request,$id){
      ...
      Mail::send('email::credit_note.email',array('email'=>$email),function($messeg) use ($pdf){
      ...
      return redirect()->back()->with('msg','Email send successfully.Pleas Check your Email');
  }
    ...
    public function expenceMailSend(Request $request,$id){
        ...
        Mail::send('email::expence.email',array('email'=>$email),function($messeg) use ($pdf){
    ...
    public function billMailSend(Request $request,$id){
        ...
        Mail::send('email::bill.email',array('email'=>$email),function($messeg) use ($pdf){
    ...
    public function paymentMadeMailSend(Request $request,$id){
        ...
        Mail::send('email::paymentmade.email',array('email'=>$email),function($messeg) use ($pdf){
    ...
    public function commissionMailSend(Request $request,$id){
        ...
        try{
            ...
            Mail::send('email::commission.email',array('email'=>$email),function($messeg) use ($pdf){
    ...
    public function estimateMailSend(Request $request,$id){
        ...
        Mail::send('email::estimate.email',array('email'=>$email),function($messeg) use ($pdf){
