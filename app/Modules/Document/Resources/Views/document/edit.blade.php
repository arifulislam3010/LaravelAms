...
@section('content')
    <div class="uk-grid" data-uk-grid-margin data-uk-grid-match id="user_profile">
        <div class="uk-width-large-10-10">
            {!! Form::open(['url' => array('document/update', $document->id), 'method' => 'post', 'class' => 'uk-form-stacked', 'id' => 'user_edit_form', 'files' => 'true']) !!}
                        ...
                        <div class="md-card">
                            ...
                            <div class="user_content">
                                <div class="uk-margin-top">
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            <select id="contact_category_id" name="contact_category_id" data-md-selectize data-md-selectize-bottom data-uk-tooltip="{pos:'top'}" required>
                                                ...
                                                @foreach($category as $contact_category)
                                                    <option value="{{ $contact_category->id }}" {{ $document->documentcategory_id == $contact_category->id ? 'selected="selected"' : '' }}>{{ $contact_category->categoryName }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            <select id="contact_category_id" name="pax_id" data-md-selectize data-md-selectize-bottom data-uk-tooltip="{pos:'top'}" required>
                                                ...
                                                @foreach($pax as $value)
                                                    <option value="{{ $value->id }}" {{ $document->pax_id== $value->id ? 'selected="selected"' : ''}}>{{ $value->paxid }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="uk-grid" data-uk-grid-margin>
                                        <div class="uk-width-medium-1-5 uk-vertical-align">
                                            <label class="uk-vertical-align-middle" for="first_name">Title </label>
                                        </div>
                                        <div class="uk-width-medium-2-5">
                                            <label for="first_name">Title</label>
                                            <input class="md-input" type="text" id="title" name="title" value="{{ $document->title }}" required />
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        <div class="uk-width-medium-1-5 uk-vertical-align">
                                            <label class="uk-vertical-align-middle" for="display_name">Select File</label>
                                        </div>
                                        <div class="uk-width-medium-2-5">
                                       ...
                                       @endif
                                        <a download href="{{ URL::to($document->file_url)  }}" target="_blank">Download <i class="material-icons">file_download</i></a>
                                    </div>
