            ...
            <div class="uk-grid uk-grid-medium" data-uk-grid-margin>
                <div class="uk-width-xLarge-10-10 uk-width-large-10-10">
                    <div class="md-card">
                        ...
                        <div class="md-card">
                            {!! Form::open(['url' => route('payment_received_update', ['id' => $payment_receive->id]), 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'my_profile', 'files' => 'true', 'enctype' => "multipart/form-data"]) !!}
                                        ...
                                        <div class="uk-width-medium-1-1">
                                            <table class="uk-table">
                                                ...
                                                <tr ng-repeat="invoice in invoices track by $index" class="form_section" >
                                                    ...
                                                    <td>@{{ invoice.amount + invoice.payment_receive_adjustment }}</td>
                                                    <td>@{{ invoice.due_amount + invoice.payment + invoice.payment_receive_adjustment }}</td>
                                                    <td>
