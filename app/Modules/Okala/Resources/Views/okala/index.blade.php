                    ...
                    <div class="md-card">
                        <div class="user_heading">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b"><span class="uk-text-truncate">Okala List</span></h2>
                            </div>
                        </div>
                        ...
                        <div class="user_content">
                            ...
                            <div class="md-fab-wrapper branch-create">
                                <a id="add_branch_button" href="{!! route('okala_create') !!}" class="md-fab md-fab-accent branch-create">
    ...
    <script>
        $('.delete_btn').click(function () {
            ...
            swal({
                ...
                window.location.href = "/okala/delete/"+id;
            })
        })
