                                    ...
                                    @foreach($basis as $value)
                                            <tr>
                                                ...
                                                <td class="uk-text-center">
                                                    <a href="{!! route('agreement_download',$value->agreement_paper_id) !!}" class="batch-edit"><i class="material-icons">file_download</i></a>
                                                    <a href="{!! route('agreement_edit',$value->agreement_paper_id) !!}" class="batch-edit"><i class="md-icon material-icons uk-margin-right">&#xE254;</i></a>
                                                    <a class="delete_btn"><i data-uk-tooltip="{pos:'top'}" title="Delete" class="md-icon material-icons">&#xE872;</i></a>
                                                    <input type="hidden" class="agreement_delete" value="{{ $value->agreement_paper_id }}">
                                                </td>
                                            </tr>
