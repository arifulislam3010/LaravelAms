...
@section('content')
    <div class="uk-grid" ng-controller="InvoiceController">
        <div class="uk-width-large-10-10">
            ...
            @endif
            {!! Form::open(['url' => route('agreement_update',$query->id), 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'my_profile', 'files' => 'true', 'enctype' => "multipart/form-data", 'novalidate']) !!}
...
//                                                            $t=$d->recruitEdit($formpax->recruit_id);
                                                            ?>


                                                            <select data-md-selectize data-uk-tooltip="{pos:'top'}" title="Select Customer" id="customer_id" name="recruit_id[]" required>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="uk_dp_start" value="{!! $query->country_name !!}" name="country_name" required>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="uk_dp_start" value="{!! $query->gender !!}" name="gender" required>
                                        @if($errors->has('country_name'))
