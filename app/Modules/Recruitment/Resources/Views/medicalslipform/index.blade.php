                                    ...
                                    @foreach($basis as $value)
                                            <tr>
                                                ...
                                                <td class="uk-text-center">
                                                    <a href="{!! route('medical_slip_form_download',$value->medicalslip_id) !!}" class="batch-edit"><i class="material-icons">file_download</i></a>
                                                    <a href="{!! route('medical_slip_form_edit',$value->medicalslip_id) !!}" class="batch-edit"><i class="md-icon material-icons uk-margin-right">&#xE254;</i></a>
                                                    <a class="delete_btn"><i data-uk-tooltip="{pos:'top'}" title="Delete" class="md-icon material-icons">&#xE872;</i></a>
                                                    <input type="hidden" class="form_medical_id" value="{{ $value->medicalslip_id }}">
                                                </td>
                                            </tr>
