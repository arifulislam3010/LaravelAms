                ...
                <div class="uk-overflow-container uk-margin-bottom">
                    <table class="uk-table uk-table-align-vertical uk-table-nowrap tablesorter tablesorter-altair" id="ts_pager_filter">
                        ...
                        <tr>
                            ...
                            <th data-priority="6">Register Serial Number</th>
                            <th data-priority="6">PassportDue Date</th>
                        ...
                        @foreach($order as $value)
                            <tr>
                                ...
                                <td>{!! $value->registerSerial_id !!}</td>
                                <td>{!! $value->passportDate  !!}</td>
                                ...
                                <td class="uk-text-center">
                                    ...
                                    <a onclick="deleterow(this); return false" href="{!! route('order_delete',$value->id) !!}" class=""><i class="md-icon material-icons">&#xE872;</i></a>
                                </td>
                            </tr>
                        </tbody>
                        @endforeach
