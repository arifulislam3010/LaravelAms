                ...
                <div class="uk-overflow-container uk-margin-bottom">
                    <table class="uk-table uk-table-align-vertical uk-table-nowrap tablesorter tablesorter-altair" id="ts_pager_filter">
                        ...
                        <tr>
                            ...
                            <th data-priority="2">Issue Date</th>
                            <th data-priority="6">Receving Date</th>
                        ...
                        @foreach($mpower as $value)
                            <tr>
                                ...
                                <td class="uk-text-center">
                                    ...
                                    <a onclick="deleterow(this); return false" href="{!! route('manpower_delete',$value->id) !!}" class=""><i class="md-icon material-icons">&#xE872;</i></a>
                                </td>
                            </tr>
                        </tbody>
                        @endforeach
