...
@section('content')
    <div class="uk-grid" ng-controller="InvoiceController">
        <div class="uk-width-large-10-10">
            ...
            @endif
            {!! Form::open(['url' => route('manpower_update',$manpower->id), 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'my_profile', 'files' => 'true', 'enctype' => "multipart/form-data", 'novalidate']) !!}
                    ...
                    <div class="md-card">
                        ...
                        <div class="user_content">
                            <div class="uk-margin-top">
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    <div class="uk-width-medium-1-5  uk-vertical-align">
                                        <label class="uk-vertical-align-middle" for="invoice_date">Issuing Date</label>
                                    </div>
                                    <div class="uk-width-medium-2-5">
                                        <label for="invoice_date">Select date</label>
                                        <input class="md-input" type="text" id="uk_dp_start" name="issuingDate" value="{!! $manpower->issuingDate !!}" data-uk-datepicker="{format:'YYYY-MM-DD'}" required>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        <label for="invoice_date">Select date</label>
                                        <input class="md-input" type="text" id="uk_dp_end" value="{!! $manpower->receivingDate !!}" name="receivingDate" data-uk-datepicker="{format:'YYYY-MM-DD'}">
                                        @if($errors->has('date'))
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <textarea type="text" name="comment" class="md-input" cols="4" rows="4">{!! $manpower->comment !!}</textarea>
                                        @if($errors->has('name'))
                                ...
                                <div class="uk-grid uk-grid-small">
                                    ...
                                    <div class="uk-width-large-2-3">
                                        <span class="uk-text-large uk-text-middle">{!! isset($manpower->createdBy['name']) ? $manpower
                                        ->createdBy['name']:''  !!}</span>
                                    </div>
                                </div>
                                <div class="uk-grid uk-grid-small">
                                    ...
                                    <div class="uk-width-large-2-3">
                                        <span class="uk-text-large uk-text-middle">{!! isset($manpower->updatedBy['name']) ? $manpower->updatedBy['name']:''  !!}</span>
                                    </div>
                                </div>
                                ...
                                <div class="uk-grid uk-grid-small">
                                    ...
                                    <div class="uk-width-large-2-3">
                                        <span class="uk-text-large uk-text-middle">{!! isset($manpower->created_at) ? $manpower->created_at:''  !!}</span>
                                    </div>
                                </div>
                                <div class="uk-grid uk-grid-small">
                                    <div class="uk-width-large-1-3">
                                    ...
                                    <div class="uk-width-large-2-3">
                                        <span class="uk-text-large uk-text-middle">{!! isset($manpower->updated_at) ? $manpower->updated_at:''  !!}</span>
                                    </div>
                                </div>
