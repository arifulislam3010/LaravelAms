                                    ...
                                    <div ng-style="{opacity : ((currentPage == 0) && '0.2') || '1'}">
                                        ...
                                        <div class="uk-grid" data-uk-grid-margin>
                                            ...
                                            <div class="uk-width-medium-2-5">
                                                ...
                                                <input class="md-input" type="text" id="payment_date" name="payment_date" ng-model="payment_date" ng-readonly="truefalse" value="{{ Carbon\Carbon::now()->format('d-m-Y') }}" data-uk-datepicker="{format:'DD-MM-YYYY'}" />
                                            </div>
