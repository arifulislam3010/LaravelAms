                        ...
                        <div class="md-card">
                            <div class="user_heading" data-uk-sticky="{ top: 48, media: 960 }">
                                ...
                                <div class="user_heading_content">
                                    ...
                                    <h2 class="heading_b"><span class="uk-text-truncate">Display Name : <small>{{ $contact->display_name }}</small></span></h2>
                                </div>
                            </div>
                            <div class="user_content">
                                <div class="uk-margin-top">
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            <label class="uk-vertical-align-middle" for="agent_name">{{ $contact->agent->display_name }}</label>
                                        </div>
                                    </div>
                                    @endif
                                    <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            <label class="uk-vertical-align-middle" for="skype_name">{{ $contact->createdBy->name }}</label>
                                        </div>
                                    </div>
                                    <div class="uk-grid" data-uk-grid-margin>
                                        <div class="uk-width-medium-1-5 uk-vertical-align">
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            <label class="uk-vertical-align-middle" for="skype_name">{{ $contact->created_at }}</label>
                                        </div>
                                    </div>
                                    <div class="uk-grid" data-uk-grid-margin>
                                        <div class="uk-width-medium-1-5 uk-vertical-align">
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            <label class="uk-vertical-align-middle" for="skype_name">{{ $contact->updatedBy->name }}</label>
                                        </div>
                                    </div>
                                    <div class="uk-grid" data-uk-grid-margin>
                                        <div class="uk-width-medium-1-5 uk-vertical-align">
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            <label class="uk-vertical-align-middle" for="skype_name">{{ $contact->updated_at }}</label>
                                        </div>
                                    </div>
                                    <div class="uk-grid">
