...
@section('content')
    <div class="uk-grid" ng-controller="InvoiceController">
        <div class="uk-width-large-10-10">
            {!! Form::open(['url' => route('bank_store'), 'method' => 'POST', 'class' => 'user_edit_form']) !!}
                        ...
                        <div class="md-card">
                            ...
                            <div class="user_content">
                                <div class="uk-margin-top">
                                    ...
                                    <div id="bank_list" style="display: none;" class="uk-grid" data-uk-grid-margin>
                                        <div class="uk-width-medium-1-5 uk-vertical-align">
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            <select style="width: 100%;border-width: 0 0 1px;padding: 8px 8px 9px;" id="account" name="account" required>

                                                @foreach($accounts as $account)
                                                    <option {{ $account->id==28?"selected":'' }} value="{{ $account->id}}">{{ $account->account_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
