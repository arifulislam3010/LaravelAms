...
class CreateTicketOrderRelationTable extends Migration
{
    ...
    public function up()
    {
        Schema::table('ticketorders', function(Blueprint $table){
            $table->foreign('bill_id')->references('id')->on('invoices')->onDelete('cascade')->onUpdate('cascade');
            $table->foreign('invoice_id')->references('id')->on('bill')->onDelete('cascade')->onUpdate('cascade');
        ...
        Schema::table('ticket_order_tax', function(Blueprint $table){
            ...
            $table->foreign('ticket_tax_id')->references('id')->on('tickettaxs')->onDelete('cascade')->onUpdate('cascade');
        });
    }
